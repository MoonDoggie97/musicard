...
import { MiniOption } from '../typings/types.js';

const Mini = async (option: MiniOption): Promise<Buffer> => {
    ...
    try {
        ...
        if (!option.backgroundImage) {
            ...
            try {
                const darknessSvg =
                    generateSvg(`<svg width="618" height="837" viewBox="0 0 618 837" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        const progressBarSvg =
            generateSvg(`<svg width="544" height="34" viewBox="0 0 544 34" fill="none" xmlns="http://www.w3.org/2000/svg">
