...
import { ClassicOption } from '../typings/types.js';
...
const Classic = async (option: ClassicOption): Promise<Buffer> => {
    ...
    try {
        ...
        if (!option.backgroundImage) {
            const backgroundSvg =
                generateSvg(`<svg width="2458" height="837" viewBox="0 0 2458 837" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect y="565" width="1568" height="272" rx="50" fill="${option.backgroundColor}"/>
            ...
            try {
                const darknessSvg =
                    generateSvg(`<svg width="1568" height="837" viewBox="0 0 1568 837" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        console.log(`Progress: ${option.progress}, Completed: ${completed}`);
